...
This package provides **BeQuant exchange plugin for bt_api** for the [bt_api](https://github.com/cloudQuant/bt_api_py) framework. It offers a unified interface for interacting with **BEQUANT** exchange.
...
| GitHub Repository | https://github.com/cloudQuant/bt_api_bequant |
| Issue Tracker | https://github.com/cloudQuant/bt_api_bequant/issues |
...
```
bt_api_bequant/
├── src/bt_api_bequant/     # Source code
...
- Report bugs via [GitHub Issues](https://github.com/cloudQuant/bt_api_bequant/issues)
...
本包为 [bt_api](https://github.com/cloudQuant/bt_api_py) 框架提供 **BeQuant exchange plugin for bt_api**。它提供了与 **BEQUANT** 交易所交互的统一接口。
...
| GitHub 仓库 | https://github.com/cloudQuant/bt_api_bequant |
...
- 通过 [GitHub Issues](https://github.com/cloudQuant/bt_api_bequant/issues) 反馈问题
